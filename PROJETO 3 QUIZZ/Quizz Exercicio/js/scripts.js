...
function createQuestion(i) {
  ...
  questions[i].answers.forEach(function (answer, i) {
    ...
    // Selecionamos a letra e o texto
    const letterBtn = answerTemplate.querySelector(".btn-letter");
    const answerText = answerTemplate.querySelector(".question-answer");

    // Substituindo a letra e o texto
    letterBtn.textContent = letters[i];
    answerText.textContent = answer['answer'];

    // Atributo mostrando se a alternativa é verdadeira ou não
...
function checkAnswer(btn) {
  ...
  // Selecionar todos os botões que estão presentes no meu documento
...
function nextQuestion() {
  ...
  // timer para usuários ver as respostas
  setTimeout(function () {
...
function showSucccessMessage() {
  ...
  const correctAnswer = document.querySelector("#corrent-answers");
...
function hideOrShowQuizz() {
  // Insiro a classe hide/score se não tiver. Retiro caso tenha
